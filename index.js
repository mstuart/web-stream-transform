...
@param {(...arguments_: unknown[]) => unknown} function_ - The function to apply to each chunk.
...
@param {(...arguments_: unknown[]) => unknown} function_ - The predicate function. Chunks where this returns false are dropped.
...
@param {number} size - Number of chunks per emitted array; a trailing partial batch is flushed on close.
...
@param {(...arguments_: unknown[]) => unknown} function_ - The function to call for each chunk.
